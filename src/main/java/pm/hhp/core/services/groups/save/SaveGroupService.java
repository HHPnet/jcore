...
public class SaveGroupService implements Service<GroupRequest, GroupResponse> {
  private GroupRepository repository;

  private GroupFactory factory;

  public SaveGroupService(GroupRepository repository, GroupFactory factory) {
  ...
  public GroupResponse execute(GroupRequest request) {
    Group group =
        factory.getGroupEntity(
            request.getGroupId().orElse(null),
            request.getName(),
