...
public class GetUserProfileByEmailServiceTest {
  private static final String USER_EMAIL = "test_email";

  private GetUserProfileByEmailService service;
  ...
  public void setUp() throws Exception {
    ...
    service = new GetUserProfileByEmailService(repository, factory);
  }
  ...
  public void itGetsAnUserWhenExisting() throws UserNotFoundException {
    ...
    verify(repository, times(1)).findByEmail(USER_EMAIL);
  }

  private void givenARequestToFindAnUser() {
    doReturn(Optional.empty()).when(request).getUserId();
